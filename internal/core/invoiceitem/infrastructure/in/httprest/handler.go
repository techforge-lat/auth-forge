...
type Handler struct {
	useCase in.InvoiceItemUseCase
}

func New(useCase in.InvoiceItemUseCase) Handler {
	return Handler{useCase: useCase}
}

func (h Handler) Create(c echo.Context) error {
	entity := domain.InvoiceItemCreateRequest{}
...
func (h Handler) UpdateByID(c echo.Context) error {
	entity := domain.InvoiceItemUpdateRequest{}
