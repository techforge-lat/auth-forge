...
type UseCase struct {
	repo out.ContractProductRepository
}

func NewUseCase(repo out.ContractProductRepository) UseCase {
	return UseCase{repo: repo}
}

func (uc UseCase) Create(ctx context.Context, entity domain.ContractProductCreateRequest) error {
...
func (uc UseCase) Update(ctx context.Context, entity domain.ContractProductUpdateRequest, filters ...dafi.Filter) error {
	if err := entity.Validate(); err != nil {
		return errortrace.OnError(err)
	}
...
func (uc UseCase) FindOne(ctx context.Context, criteria dafi.Criteria) (domain.ContractProduct, error) {
...
func (uc UseCase) FindAll(ctx context.Context, criteria dafi.Criteria) ([]domain.ContractProduct, error) {
