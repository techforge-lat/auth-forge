...
type Handler struct {
	useCase in.ContractProductUseCase
}

func New(useCase in.ContractProductUseCase) Handler {
	return Handler{useCase: useCase}
}

func (h Handler) Create(c echo.Context) error {
	entity := domain.ContractProductCreateRequest{}
...
func (h Handler) UpdateByID(c echo.Context) error {
	entity := domain.ContractProductUpdateRequest{}
