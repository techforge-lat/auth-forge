...
func (r Repository) WithTx(tx out.Transaction) out.ContractRepository {
	return Repository{
		db: r.db,
		tx: tx.GetTx(),
	}
...
func (r Repository) Create(ctx context.Context, entity domain.ContractCreateRequest) error {
	result, err := insertQuery.WithValues(entity.OwnerCustomerID, entity.BillingCustomerID, entity.BeginsAt, entity.EndsAt, entity.Commitment, entity.PaymentFrequency, entity.RenewalDate, entity.State, entity.Attachments, entity.CreatedAt).ToSQL()
	if err != nil {
...
func (r Repository) Update(ctx context.Context, entity domain.ContractUpdateRequest, filters ...dafi.Filter) error {
	if !entity.UpdatedAt.Valid {
		entity.UpdatedAt.SetValid(time.Now())
	}

	result, err := updateQuery.WithValues(entity.OwnerCustomerID, entity.BillingCustomerID, entity.BeginsAt, entity.EndsAt, entity.Commitment, entity.PaymentFrequency, entity.RenewalDate, entity.State, entity.Attachments, entity.UpdatedAt).Where(filters...).ToSQL()
	if err != nil {
		return errortrace.OnError(err)
	}
...
func (r Repository) FindOne(ctx context.Context, criteria dafi.Criteria) (domain.Contract, error) {
	...
	if err != nil {
		return domain.Contract{}, errortrace.OnError(err)
	}

	var m domain.Contract
...
func (r Repository) FindAll(ctx context.Context, criteria dafi.Criteria) ([]domain.Contract, error) {
