...
type Handler struct {
	useCase in.InvoiceCalculationItemUseCase
}

func New(useCase in.InvoiceCalculationItemUseCase) Handler {
	return Handler{useCase: useCase}
}

func (h Handler) Create(c echo.Context) error {
	entity := domain.InvoiceCalculationItemCreateRequest{}
...
func (h Handler) UpdateByID(c echo.Context) error {
	entity := domain.InvoiceCalculationItemUpdateRequest{}
