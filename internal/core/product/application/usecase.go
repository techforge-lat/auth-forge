...
func NewUseCase(repo out.ProductRepository) UseCase {
	return UseCase{repo: repo}
}

func (uc UseCase) Create(ctx context.Context, entity domain.ProductCreateRequest) error {
...
func (uc UseCase) Update(ctx context.Context, entity domain.ProductUpdateRequest, filters ...dafi.Filter) error {
	if err := entity.Validate(); err != nil {
		return errortrace.OnError(err)
	}
...
func (uc UseCase) FindOne(ctx context.Context, criteria dafi.Criteria) (domain.Product, error) {
...
func (uc UseCase) FindAll(ctx context.Context, criteria dafi.Criteria) ([]domain.Product, error) {
