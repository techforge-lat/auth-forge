...
type Handler struct {
	useCase in.InvoiceCalculationUseCase
}

func New(useCase in.InvoiceCalculationUseCase) Handler {
	return Handler{useCase: useCase}
}

func (h Handler) Create(c echo.Context) error {
	entity := domain.InvoiceCalculationCreateRequest{}
...
func (h Handler) UpdateByID(c echo.Context) error {
	entity := domain.InvoiceCalculationUpdateRequest{}
