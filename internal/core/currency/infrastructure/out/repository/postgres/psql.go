...
func (r Repository) WithTx(tx out.Transaction) out.CurrencyRepository {
	return Repository{
		db: r.db,
		tx: tx.GetTx(),
	}
...
func (r Repository) Create(ctx context.Context, entity domain.CurrencyCreateRequest) error {
	result, err := insertQuery.WithValues(entity.Name, entity.Symbol, entity.ExchangeRate, entity.CreatedAt).ToSQL()
	if err != nil {
...
func (r Repository) Update(ctx context.Context, entity domain.CurrencyUpdateRequest, filters ...dafi.Filter) error {
	if !entity.UpdatedAt.Valid {
		entity.UpdatedAt.SetValid(time.Now())
	}

	result, err := updateQuery.WithValues(entity.Name, entity.Symbol, entity.ExchangeRate, entity.UpdatedAt).Where(filters...).ToSQL()
	if err != nil {
		return errortrace.OnError(err)
	}
...
func (r Repository) FindOne(ctx context.Context, criteria dafi.Criteria) (domain.Currency, error) {
...
func (r Repository) FindAll(ctx context.Context, criteria dafi.Criteria) ([]domain.Currency, error) {
