...
type Handler struct {
	useCase in.InvoicePaymentUseCase
}

func New(useCase in.InvoicePaymentUseCase) Handler {
	return Handler{useCase: useCase}
}

func (h Handler) Create(c echo.Context) error {
	entity := domain.InvoicePaymentCreateRequest{}
...
func (h Handler) UpdateByID(c echo.Context) error {
	entity := domain.InvoicePaymentUpdateRequest{}
