...
type UseCase struct {
	repo out.SupplierRepository
}

func NewUseCase(repo out.SupplierRepository) UseCase {
	return UseCase{repo: repo}
}

func (uc UseCase) Create(ctx context.Context, entity domain.SupplierCreateRequest) error {
...
func (uc UseCase) Update(ctx context.Context, entity domain.SupplierUpdateRequest, filters ...dafi.Filter) error {
	if err := entity.Validate(); err != nil {
		return errortrace.OnError(err)
	}
...
func (uc UseCase) FindOne(ctx context.Context, criteria dafi.Criteria) (domain.Supplier, error) {
...
func (uc UseCase) FindAll(ctx context.Context, criteria dafi.Criteria) ([]domain.Supplier, error) {
