...
type Handler struct {
	useCase in.PaymentAccountUseCase
}

func New(useCase in.PaymentAccountUseCase) Handler {
	return Handler{useCase: useCase}
}

func (h Handler) Create(c echo.Context) error {
	entity := domain.PaymentAccountCreateRequest{}
...
func (h Handler) UpdateByID(c echo.Context) error {
	entity := domain.PaymentAccountUpdateRequest{}
