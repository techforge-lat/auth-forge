...
type UseCase struct {
	repo out.ProductPriceRepository
}

func NewUseCase(repo out.ProductPriceRepository) UseCase {
	return UseCase{repo: repo}
}

func (uc UseCase) Create(ctx context.Context, entity domain.ProductPriceCreateRequest) error {
...
func (uc UseCase) Update(ctx context.Context, entity domain.ProductPriceUpdateRequest, filters ...dafi.Filter) error {
	if err := entity.Validate(); err != nil {
		return errortrace.OnError(err)
	}
...
func (uc UseCase) FindOne(ctx context.Context, criteria dafi.Criteria) (domain.ProductPrice, error) {
...
func (uc UseCase) FindAll(ctx context.Context, criteria dafi.Criteria) ([]domain.ProductPrice, error) {
