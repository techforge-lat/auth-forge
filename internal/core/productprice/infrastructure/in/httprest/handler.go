...
type Handler struct {
	useCase in.ProductPriceUseCase
}

func New(useCase in.ProductPriceUseCase) Handler {
	return Handler{useCase: useCase}
}

func (h Handler) Create(c echo.Context) error {
	entity := domain.ProductPriceCreateRequest{}
...
func (h Handler) UpdateByID(c echo.Context) error {
	entity := domain.ProductPriceUpdateRequest{}
